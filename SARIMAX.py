...
output_excel_path = r'C:\Users\HP\Downloads\Time Series\wheat_Arrival.xlsx'
...
#excel_path = r'C:\Users\HP\Downloads\Time Series\wheat_Arrival.xlsx'
...
model = pm.auto_arima(train_data['Price'],exogenous=df['Arrival'],seasonal=True, m=7, trace=True)
...
import statsmodels.api as sm
exog=df['Arrival']
model = sm.tsa.ARIMA(endog, exog=exog, order=(p, d, q))
results = model.fit()
